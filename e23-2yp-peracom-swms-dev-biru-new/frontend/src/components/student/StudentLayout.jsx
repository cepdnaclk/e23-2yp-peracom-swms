...
import { BookOpen, FileText, BarChart2, User, LayoutDashboard, Bell, LogOut, Menu, X, MessageSquare } from 'lucide-react'
...
const navLinks = [
  ...
  { to: '/student/issues', label: 'Issues', icon: MessageSquare},
      ...
      <nav className="bg-white border-b border-slate-100 shadow-sm sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center gap-6">
          ...
          <div className="flex items-center gap-2 ml-auto">
            <button className="p-2 rounded-lg text-slate-500 hover:text-purple-600 hover:bg-purple-50 transition-colors relative">
              <Bell size={18} />
            </button>
